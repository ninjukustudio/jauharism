...
const JAUHARI_SYSTEM_INSTRUCTION = `
...
// Comprehensive Semantic Knowledge Synthesizer for offline / network outage resilience
function generateSemanticAnswer(question: string, contextAxiomId?: string): string {
